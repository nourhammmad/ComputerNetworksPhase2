                ...
                for s in readable:
                    ...
                    # is used to communicate with a connected peer, then enters here
                        ...
                        # if an REJECT message is received then ischatrequested is made 0 so that it can receive any other chat requests
                            ...
                            self.isChatRequested = 0
                            inputs.remove(s)
                        # if a message is received, and if this != a quit message ':q' and 
...
class PeerClient(threading.Thread):
    ...
    def run(self):
        ...
        # if the server of this peer != connected by someone else and if this is the requester side peer client then enters here
...
class peerMain:
    ...
    def __init__(self):
        ...
        while choice != "3":
            ...
            # if choice is 2 and user != logged in, asks for the username
            ...
            # is peer != logged in and exits the program
            elif choice == "3":
                self.logout(2)
...
try:
    ...
    print_with_color("An error ocurred while connecting to registry", Fore.RED)